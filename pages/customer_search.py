...
st.markdown(
    ...
    f"A modell megtalálja a valódi lemorzsolódók {model_recall_pct:.1f}%-át (recall), "
    f"akit lemorzsolódónak nevez, azoknak {model_precision_pct:.2f}%-a (precision) ténylegesen lemorzsolódik (holdout tesztszetten mérve).</span>"
    f"</div>"
    ...
    f"💡 <b style='color:rgba(200,207,232,0.9);'>30–70% közötti sáv az ú.n. \"szürke zóna\":</b> a leginkább befolyásolható kimenetelű ügyfelek: "
