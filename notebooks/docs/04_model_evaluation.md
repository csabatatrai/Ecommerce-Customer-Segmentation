...
- `data/processed/test_set.parquet` (holdout teszt szett – 03-as notebook 11.2-es cellája)
...
## 11. Modell betöltése és adatok előkészítése
...
### 11.2 A mentett modell betöltése

A `xgboost_churn.joblib` a 03-as notebook `11.1` cellájában lett elmentve: a teljes `X`, `y` adathalmazon
...
```python
# ============================================================
# 11.2 – Modell betöltése és pipeline típus detektálása
# ============================================================
...
### 11.3 Holdout teszt szett betöltése

A 03-as notebook `11.2` cellája mentette el a `test_set.parquet`-et.
...
### 11.4 Teljes ügyfélbázis rekonstrukciója
...
```python
# ============================================================
# 11.4 – Teljes X rekonstrukciója (azonos logika, mint 03 / 6.2–6.5)
# ============================================================
...
### 12.1 Churn valószínűségek eloszlása
...
```python
# ============================================================
# 12.1 – Churn valószínűségek eloszlása (teszt szett)
# ============================================================
...
![png](images/04_model_evaluation/04_12.1_Churn_valószínűségek_eloszlása.png)
...
### 12.2 Kalibrációs ellenőrzés (Reliability Diagram)
...
![png](images/04_model_evaluation/04_12.2_Kalibrációs_ellenőrzés_(Reliability_Diagram).png)
...
### 12.3 Threshold optimalizálás (Precision-Recall görbe)
...
```python
# ============================================================
# 12.3 – Threshold optimalizálás (PR görbe alapján)
# ============================================================
...
![png](images/04_model_evaluation/04_12.3_Threshold_optimalizálás_(Precision-Recall_görbe).png)
...
### 12.4 Konfúziós mátrix az optimális küszöbön
...
![png](images/04_model_evaluation/04_12.4_Konfúziós_mátrix_az_optimális_küszöbön.png)
...
## 13. Modell magyarázata, SHAP elemzés
...
```
    ...
    ExactExplainer explainer: 5244it [00:32, 159.14it/s]                                                                   
...
### 13.2 SHAP Summary Plot – Globális feature fontosság
...
![png](images/04_model_evaluation/04_13.2_SHAP_Summary_Plot_–_Globális_feature_fontosság.png)
...
### 13.3 SHAP Waterfall Plot – Egyedi VIP ügyfél magyarázata
...
```python
# ============================================================
# 13.3 – SHAP Waterfall Plot (VIP lemorzsolódó ügyfél)
# ============================================================
...
<table id="T_246e3">
  <thead>
    <tr>
      ...
      <th id="T_246e3_level0_col0" class="col_heading level0 col0" >recency_days</th>
      <th id="T_246e3_level0_col1" class="col_heading level0 col1" >frequency</th>
      <th id="T_246e3_level0_col2" class="col_heading level0 col2" >monetary_total</th>
      <th id="T_246e3_level0_col3" class="col_heading level0 col3" >monetary_avg</th>
      <th id="T_246e3_level0_col4" class="col_heading level0 col4" >return_ratio</th>
      <th id="T_246e3_level0_col5" class="col_heading level0 col5" >churn</th>
      <th id="T_246e3_level0_col6" class="col_heading level0 col6" >churn_proba</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <th id="T_246e3_level0_row0" class="row_heading level0 row0" >17305</th>
      <td id="T_246e3_row0_col0" class="data row0 col0" >556</td>
      <td id="T_246e3_row0_col1" class="data row0 col1" >1.000000</td>
      <td id="T_246e3_row0_col2" class="data row0 col2" >£2,135</td>
      <td id="T_246e3_row0_col3" class="data row0 col3" >£2,135</td>
      <td id="T_246e3_row0_col4" class="data row0 col4" >0.000000</td>
      <td id="T_246e3_row0_col5" class="data row0 col5" >1.000000</td>
      <td id="T_246e3_row0_col6" class="data row0 col6" >75.26%</td>
    </tr>
  </tbody>
</table>
...
![png](images/04_model_evaluation/04_13.3_SHAP_Waterfall_Plot_–_Egyedi_VIP_ügyfél_magyarázata.png)
    


### 13.4 Feature importance konzisztencia-ellenőrzés: XGBoost natív vs. SHAP
...
```python
# ============================================================
# 13.4 – XGBoost natív feature importance vs. SHAP
# ============================================================
...
![png](images/04_model_evaluation/04_13.4_Feature_importance_konzisztencia-ellenőrzés_XGBoost_natív_vs._SHAP.png)
...
## 14. Üzleti kiértékelés és akciótervek
...
thresholdot** (`BEST_THRESHOLD`) használja a hardcoded 0.5 helyett – ez a 12.3-as cella
eredménye visszacsatolva az üzleti döntésbe.

### 14.1 Prioritizált akciólista – az összes ügyfélre
...
```python
# ============================================================
# 14.1 – Prioritizált akciólista (optimalizált threshold)
# ============================================================
...
### 14.2 VIP Veszélyben lista – TOP 20
...
<style type="text/css">
#T_5a5a1_row0_col5, #T_5a5a1_row1_col5, #T_5a5a1_row2_col5, #T_5a5a1_row3_col5, #T_5a5a1_row4_col5, #T_5a5a1_row5_col5, #T_5a5a1_row6_col5, #T_5a5a1_row7_col5, #T_5a5a1_row8_col5 {
  background-color: #67000d;
  color: #f1f1f1;
}
#T_5a5a1_row9_col5, #T_5a5a1_row10_col5, #T_5a5a1_row11_col5 {
  background-color: #fcb499;
  color: #000000;
}
#T_5a5a1_row12_col5, #T_5a5a1_row13_col5, #T_5a5a1_row14_col5, #T_5a5a1_row15_col5 {
  background-color: #fed8c7;
  color: #000000;
}
#T_5a5a1_row16_col5, #T_5a5a1_row17_col5 {
  background-color: #fee4d8;
  color: #000000;
}
#T_5a5a1_row18_col5, #T_5a5a1_row19_col5 {
...
<table id="T_5a5a1">
  <thead>
    <tr>
      <th class="blank level0" >&nbsp;</th>
      <th id="T_5a5a1_level0_col0" class="col_heading level0 col0" >monetary_total</th>
      <th id="T_5a5a1_level0_col1" class="col_heading level0 col1" >frequency</th>
      <th id="T_5a5a1_level0_col2" class="col_heading level0 col2" >recency_days</th>
      <th id="T_5a5a1_level0_col3" class="col_heading level0 col3" >return_ratio</th>
      <th id="T_5a5a1_level0_col4" class="col_heading level0 col4" >rfm_segment</th>
      <th id="T_5a5a1_level0_col5" class="col_heading level0 col5" >churn_proba</th>
    </tr>
    <tr>
  ...
  <tbody>
    <tr>
      <th id="T_5a5a1_level0_row0" class="row_heading level0 row0" >12368</th>
      <td id="T_5a5a1_row0_col0" class="data row0 col0" >£918</td>
      <td id="T_5a5a1_row0_col1" class="data row0 col1" >1</td>
      <td id="T_5a5a1_row0_col2" class="data row0 col2" >536 nap</td>
      <td id="T_5a5a1_row0_col3" class="data row0 col3" >0.0%</td>
      <td id="T_5a5a1_row0_col4" class="data row0 col4" >Elvesztett / Inaktív</td>
      <td id="T_5a5a1_row0_col5" class="data row0 col5" >75.6%</td>
    </tr>
    <tr>
      <th id="T_5a5a1_level0_row1" class="row_heading level0 row1" >13775</th>
      <td id="T_5a5a1_row1_col0" class="data row1 col0" >£1,050</td>
      <td id="T_5a5a1_row1_col1" class="data row1 col1" >1</td>
      <td id="T_5a5a1_row1_col2" class="data row1 col2" >498 nap</td>
      <td id="T_5a5a1_row1_col3" class="data row1 col3" >0.0%</td>
      <td id="T_5a5a1_row1_col4" class="data row1 col4" >Elvesztett / Inaktív</td>
      <td id="T_5a5a1_row1_col5" class="data row1 col5" >75.6%</td>
    </tr>
    <tr>
      <th id="T_5a5a1_level0_row2" class="row_heading level0 row2" >17474</th>
      <td id="T_5a5a1_row2_col0" class="data row2 col0" >£1,047</td>
      <td id="T_5a5a1_row2_col1" class="data row2 col1" >1</td>
      <td id="T_5a5a1_row2_col2" class="data row2 col2" >507 nap</td>
      <td id="T_5a5a1_row2_col3" class="data row2 col3" >0.0%</td>
      <td id="T_5a5a1_row2_col4" class="data row2 col4" >Elvesztett / Inaktív</td>
      <td id="T_5a5a1_row2_col5" class="data row2 col5" >75.6%</td>
    </tr>
    <tr>
      <th id="T_5a5a1_level0_row3" class="row_heading level0 row3" >12784</th>
      <td id="T_5a5a1_row3_col0" class="data row3 col0" >£1,034</td>
      <td id="T_5a5a1_row3_col1" class="data row3 col1" >1</td>
      <td id="T_5a5a1_row3_col2" class="data row3 col2" >437 nap</td>
      <td id="T_5a5a1_row3_col3" class="data row3 col3" >0.0%</td>
      <td id="T_5a5a1_row3_col4" class="data row3 col4" >Elvesztett / Inaktív</td>
      <td id="T_5a5a1_row3_col5" class="data row3 col5" >75.6%</td>
    </tr>
    <tr>
      <th id="T_5a5a1_level0_row4" class="row_heading level0 row4" >13204</th>
      <td id="T_5a5a1_row4_col0" class="data row4 col0" >£967</td>
      <td id="T_5a5a1_row4_col1" class="data row4 col1" >1</td>
      <td id="T_5a5a1_row4_col2" class="data row4 col2" >639 nap</td>
      <td id="T_5a5a1_row4_col3" class="data row4 col3" >0.0%</td>
      <td id="T_5a5a1_row4_col4" class="data row4 col4" >Elvesztett / Inaktív</td>
      <td id="T_5a5a1_row4_col5" class="data row4 col5" >75.6%</td>
    </tr>
    <tr>
      <th id="T_5a5a1_level0_row5" class="row_heading level0 row5" >12396</th>
      <td id="T_5a5a1_row5_col0" class="data row5 col0" >£931</td>
      <td id="T_5a5a1_row5_col1" class="data row5 col1" >1</td>
      <td id="T_5a5a1_row5_col2" class="data row5 col2" >582 nap</td>
      <td id="T_5a5a1_row5_col3" class="data row5 col3" >0.0%</td>
      <td id="T_5a5a1_row5_col4" class="data row5 col4" >Elvesztett / Inaktív</td>
      <td id="T_5a5a1_row5_col5" class="data row5 col5" >75.6%</td>
    </tr>
    <tr>
      <th id="T_5a5a1_level0_row6" class="row_heading level0 row6" >12503</th>
      <td id="T_5a5a1_row6_col0" class="data row6 col0" >£896</td>
      <td id="T_5a5a1_row6_col1" class="data row6 col1" >1</td>
      <td id="T_5a5a1_row6_col2" class="data row6 col2" >492 nap</td>
      <td id="T_5a5a1_row6_col3" class="data row6 col3" >0.0%</td>
      <td id="T_5a5a1_row6_col4" class="data row6 col4" >Elvesztett / Inaktív</td>
      <td id="T_5a5a1_row6_col5" class="data row6 col5" >75.6%</td>
    </tr>
    <tr>
      <th id="T_5a5a1_level0_row7" class="row_heading level0 row7" >14969</th>
      <td id="T_5a5a1_row7_col0" class="data row7 col0" >£906</td>
      <td id="T_5a5a1_row7_col1" class="data row7 col1" >1</td>
      <td id="T_5a5a1_row7_col2" class="data row7 col2" >611 nap</td>
      <td id="T_5a5a1_row7_col3" class="data row7 col3" >0.0%</td>
      <td id="T_5a5a1_row7_col4" class="data row7 col4" >Elvesztett / Inaktív</td>
      <td id="T_5a5a1_row7_col5" class="data row7 col5" >75.6%</td>
    </tr>
    <tr>
      <th id="T_5a5a1_level0_row8" class="row_heading level0 row8" >15559</th>
      <td id="T_5a5a1_row8_col0" class="data row8 col0" >£1,109</td>
      <td id="T_5a5a1_row8_col1" class="data row8 col1" >1</td>
      <td id="T_5a5a1_row8_col2" class="data row8 col2" >476 nap</td>
      <td id="T_5a5a1_row8_col3" class="data row8 col3" >0.0%</td>
      <td id="T_5a5a1_row8_col4" class="data row8 col4" >Elvesztett / Inaktív</td>
      <td id="T_5a5a1_row8_col5" class="data row8 col5" >75.6%</td>
    </tr>
    <tr>
      <th id="T_5a5a1_level0_row9" class="row_heading level0 row9" >17039</th>
      <td id="T_5a5a1_row9_col0" class="data row9 col0" >£1,955</td>
      <td id="T_5a5a1_row9_col1" class="data row9 col1" >1</td>
      <td id="T_5a5a1_row9_col2" class="data row9 col2" >512 nap</td>
      <td id="T_5a5a1_row9_col3" class="data row9 col3" >0.0%</td>
      <td id="T_5a5a1_row9_col4" class="data row9 col4" >Elvesztett / Inaktív</td>
      <td id="T_5a5a1_row9_col5" class="data row9 col5" >75.3%</td>
    </tr>
    <tr>
      <th id="T_5a5a1_level0_row10" class="row_heading level0 row10" >12911</th>
      <td id="T_5a5a1_row10_col0" class="data row10 col0" >£1,652</td>
      <td id="T_5a5a1_row10_col1" class="data row10 col1" >1</td>
      <td id="T_5a5a1_row10_col2" class="data row10 col2" >459 nap</td>
      <td id="T_5a5a1_row10_col3" class="data row10 col3" >0.0%</td>
      <td id="T_5a5a1_row10_col4" class="data row10 col4" >Elvesztett / Inaktív</td>
      <td id="T_5a5a1_row10_col5" class="data row10 col5" >75.3%</td>
    </tr>
    <tr>
      <th id="T_5a5a1_level0_row11" class="row_heading level0 row11" >17305</th>
      <td id="T_5a5a1_row11_col0" class="data row11 col0" >£2,135</td>
      <td id="T_5a5a1_row11_col1" class="data row11 col1" >1</td>
      <td id="T_5a5a1_row11_col2" class="data row11 col2" >556 nap</td>
      <td id="T_5a5a1_row11_col3" class="data row11 col3" >0.0%</td>
      <td id="T_5a5a1_row11_col4" class="data row11 col4" >Lemorzsolódó / Alvó</td>
      <td id="T_5a5a1_row11_col5" class="data row11 col5" >75.3%</td>
    </tr>
    <tr>
      <th id="T_5a5a1_level0_row12" class="row_heading level0 row12" >13559</th>
      <td id="T_5a5a1_row12_col0" class="data row12 col0" >£990</td>
      <td id="T_5a5a1_row12_col1" class="data row12 col1" >2</td>
      <td id="T_5a5a1_row12_col2" class="data row12 col2" >420 nap</td>
      <td id="T_5a5a1_row12_col3" class="data row12 col3" >0.0%</td>
      <td id="T_5a5a1_row12_col4" class="data row12 col4" >Elvesztett / Inaktív</td>
      <td id="T_5a5a1_row12_col5" class="data row12 col5" >75.2%</td>
    </tr>
    <tr>
      <th id="T_5a5a1_level0_row13" class="row_heading level0 row13" >12905</th>
      <td id="T_5a5a1_row13_col0" class="data row13 col0" >£1,012</td>
      <td id="T_5a5a1_row13_col1" class="data row13 col1" >2</td>
      <td id="T_5a5a1_row13_col2" class="data row13 col2" >484 nap</td>
      <td id="T_5a5a1_row13_col3" class="data row13 col3" >33.3%</td>
      <td id="T_5a5a1_row13_col4" class="data row13 col4" >Elvesztett / Inaktív</td>
      <td id="T_5a5a1_row13_col5" class="data row13 col5" >75.2%</td>
    </tr>
    <tr>
      <th id="T_5a5a1_level0_row14" class="row_heading level0 row14" >15484</th>
      <td id="T_5a5a1_row14_col0" class="data row14 col0" >£1,062</td>
      <td id="T_5a5a1_row14_col1" class="data row14 col1" >2</td>
      <td id="T_5a5a1_row14_col2" class="data row14 col2" >448 nap</td>
      <td id="T_5a5a1_row14_col3" class="data row14 col3" >0.0%</td>
      <td id="T_5a5a1_row14_col4" class="data row14 col4" >Lemorzsolódó / Alvó</td>
      <td id="T_5a5a1_row14_col5" class="data row14 col5" >75.2%</td>
    </tr>
    <tr>
      <th id="T_5a5a1_level0_row15" class="row_heading level0 row15" >17020</th>
      <td id="T_5a5a1_row15_col0" class="data row15 col0" >£936</td>
      <td id="T_5a5a1_row15_col1" class="data row15 col1" >2</td>
      <td id="T_5a5a1_row15_col2" class="data row15 col2" >450 nap</td>
      <td id="T_5a5a1_row15_col3" class="data row15 col3" >0.0%</td>
      <td id="T_5a5a1_row15_col4" class="data row15 col4" >Elvesztett / Inaktív</td>
      <td id="T_5a5a1_row15_col5" class="data row15 col5" >75.2%</td>
    </tr>
    <tr>
      <th id="T_5a5a1_level0_row16" class="row_heading level0 row16" >12671</th>
      <td id="T_5a5a1_row16_col0" class="data row16 col0" >£2,622</td>
      <td id="T_5a5a1_row16_col1" class="data row16 col1" >1</td>
      <td id="T_5a5a1_row16_col2" class="data row16 col2" >514 nap</td>
      <td id="T_5a5a1_row16_col3" class="data row16 col3" >0.0%</td>
      <td id="T_5a5a1_row16_col4" class="data row16 col4" >Lemorzsolódó / Alvó</td>
      <td id="T_5a5a1_row16_col5" class="data row16 col5" >75.2%</td>
    </tr>
    <tr>
      <th id="T_5a5a1_level0_row17" class="row_heading level0 row17" >18052</th>
      <td id="T_5a5a1_row17_col0" class="data row17 col0" >£10,877</td>
      <td id="T_5a5a1_row17_col1" class="data row17 col1" >1</td>
      <td id="T_5a5a1_row17_col2" class="data row17 col2" >472 nap</td>
      <td id="T_5a5a1_row17_col3" class="data row17 col3" >0.0%</td>
      <td id="T_5a5a1_row17_col4" class="data row17 col4" >Lemorzsolódó / Alvó</td>
      <td id="T_5a5a1_row17_col5" class="data row17 col5" >75.2%</td>
    </tr>
    <tr>
      <th id="T_5a5a1_level0_row18" class="row_heading level0 row18" >13459</th>
      <td id="T_5a5a1_row18_col0" class="data row18 col0" >£1,160</td>
      <td id="T_5a5a1_row18_col1" class="data row18 col1" >2</td>
      <td id="T_5a5a1_row18_col2" class="data row18 col2" >532 nap</td>
      <td id="T_5a5a1_row18_col3" class="data row18 col3" >0.0%</td>
      <td id="T_5a5a1_row18_col4" class="data row18 col4" >Lemorzsolódó / Alvó</td>
      <td id="T_5a5a1_row18_col5" class="data row18 col5" >75.1%</td>
    </tr>
    <tr>
      <th id="T_5a5a1_level0_row19" class="row_heading level0 row19" >17622</th>
      <td id="T_5a5a1_row19_col0" class="data row19 col0" >£1,125</td>
      <td id="T_5a5a1_row19_col1" class="data row19 col1" >2</td>
      <td id="T_5a5a1_row19_col2" class="data row19 col2" >505 nap</td>
      <td id="T_5a5a1_row19_col3" class="data row19 col3" >33.3%</td>
      <td id="T_5a5a1_row19_col4" class="data row19 col4" >Lemorzsolódó / Alvó</td>
      <td id="T_5a5a1_row19_col5" class="data row19 col5" >75.1%</td>
    </tr>
  </tbody>
</table>
...
## 15. Export, előrejelzések mentése
...
### 15.1 – Előrejelzések exportja (Streamlit / BI dashboard)
...
# SHAP fontossági értékek exportja (dashboard konzisztenciához)
# shap_norm: a 13.4-es cellában számított mean(|SHAP|) / sum, feature-enként normalizálva
SHAP_IMPORTANCE_PATH = PROCESSED_DIR / 'shap_importance.parquet'
shap_norm.rename('shap_importance').to_frame().to_parquet(SHAP_IMPORTANCE_PATH, compression='snappy')
print(f"\n✔️ SHAP fontossági értékek mentve: {SHAP_IMPORTANCE_PATH}")
...
```
    ...
    ✔️ SHAP fontossági értékek mentve: D:\Workspace\ecommerce-customer-segmentation\data\processed\shap_importance.parquet
...
```
    ...
    [04_model_evaluation.ipynb] [OK] Kesz! (0 kep)
